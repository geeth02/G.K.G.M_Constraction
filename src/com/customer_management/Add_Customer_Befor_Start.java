 ...
 * @author geeth
 */
public class Add_Customer_Befor_Start extends javax.swing.JFrame {

    /**
     * Creates new form Add_Customer_Befor_Start
     */
    public Add_Customer_Befor_Start() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Add_Customer_Befor_Start.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void addDB() {
        try {
            ...
            if(search.next()){
             ...
             Start_Job.txtVehicleNumber.grabFocus();
             this.dispose();
             }else{}
            }else{
            String gender;
             ...
             new Start_Job().setVisible(true);
             Start_Job.txtCustomerId.setText(txtReId.getText());
             Start_Job.txtVehicleNumber.grabFocus();
