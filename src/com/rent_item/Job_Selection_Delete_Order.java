 ...
 * @author geeth
 */
public class Job_Selection_Delete_Order extends javax.swing.JFrame {

    /**
     * Creates new form Add_Customer_Befor_Start
     */
    public Job_Selection_Delete_Order() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Job_Selection_Delete_Order.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void addData() {
        try {
            ...
            System.out.println(orderId);
                ...
                if (search1.next()) {
                    Delete_Rent_order.txtCustomerId.setText(search.getString("customer_id") + "-" + search1.getString("first_name") + " " + search1.getString("last_name"));
                    Delete_Rent_order.txtSearch.setText(search1.getString("nic_number"));
                    Delete_Rent_order.txtOrderId.setText(orderId);
                    Delete_Rent_order.comboSearch.setSelectedIndex(0);
                }
                
                ResultSet search2 = DB.search("SELECT * FROM rent_order_item WHERE order_id='"+orderId+"'");
                 DefaultTableModel dtm =(DefaultTableModel)Delete_Rent_order.tb3.getModel();
                 dtm.setRowCount(0);
                while(search2.next()){
               Vector v = new Vector();
      ...
      //  if (Paymets.comboSearch.getSelectedItem().equals("NIC Number")) {
            try {
                String search = Delete_Rent_order.jList1.getSelectedValue().split("-")[0];
