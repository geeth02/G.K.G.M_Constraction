 ...
 * @author geeth
 */
public class Add_Customer_List_Order extends javax.swing.JFrame {

    /**
     * Creates new form Add_Customer_Befor_Start
     */
    public Add_Customer_List_Order() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Add_Customer_List_Order.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void addDB() {
        try {
            ...
            if(search.next()){
             ...
             List_Order.txtCustomerId.setText(search.getString("customer_id"));
             List_Order.txtVehicleNumber.grabFocus();
             this.dispose();
             }else{}
            }else{
            String gender;
             ...
             new List_Order().setVisible(true);
            List_Order.txtCustomerId.setText(txtReId.getText());
            List_Order.txtVehicleNumber.grabFocus();
