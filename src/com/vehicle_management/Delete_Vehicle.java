...
public class Delete_Vehicle extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        ReForm.add(tbnDelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 310, 204, -1));
    ...
    private void tbnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tbnDeleteActionPerformed
        try {
        DB.iud("update vehicle set status='"+"0"+"' where vehicle_id='"+txtSearch.getText()+"'");
