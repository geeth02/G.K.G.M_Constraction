 ...
 * @author geeth
 */
public class Edite_Rent_Order extends javax.swing.JFrame {

    /**
     * Creates new form Start_Job
     */
    public Edite_Rent_Order() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Edite_Rent_Order.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Edite_Rent_Order().setVisible(true);
            }
        });
    }
