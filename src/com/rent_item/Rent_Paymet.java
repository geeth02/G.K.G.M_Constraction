 ...
 * @author geeth
 */
public class Rent_Paymet extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtRentItem = new javax.swing.JTextField();
        ...
        txtRentItem.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        txtRentItem.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        txtRentItem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtRentItemActionPerformed(evt);
            }
        });
        ReForm.add(txtRentItem, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 230, 480, 40));
        ...
        jLabel9.setText("Rent Item");
        ReForm.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 228, 175, 40));
        ...
        jLayeredPane1.add(ReForm, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 20, 780, 600));
        ...
        jLayeredPane1.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 630, 780, 280));
    ...
    private void txtRentItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtRentItemActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtRentItemActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Rent_Paymet.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    public static javax.swing.JTextField txtRentItem;
     ...
     private void searchNic() {
                try {
                  ...
                  while(search4.next()){
                      ...
                      if(search2.next()){
                      if(!txtRentItem.getText().equals("")){
                      txtRentItem.setText(txtRentItem.getText()+" AND "+ search4.getString("item_id")+"-"+search2.getString("name"));
                  }else{
                      txtRentItem.setText(search4.getString("item_id")+"-"+search2.getString("name"));
                      }
                  }
                  }
