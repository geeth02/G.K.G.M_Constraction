 ...
 * @author geeth
 */
public class Select_List extends javax.swing.JFrame {
...
String id;
    ...
    private void initComponents() {
        ...
        ReForm.add(btnRegister3, new org.netbeans.lib.awtextra.AbsoluteConstraints(830, 640, 210, 60));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Select_List.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void selectJob() {
        try {
           ...
           this.dispose();
            ...
            if(search.next()){
           Start_Job.listId=search.getString("id");
           Start_Job.txtCustomerId.setText(search.getString("customer_id"));
           Start_Job.txtVehicleNumber.setText(search.getString("vehicle_number"));
           Start_Job.txtLocation.setText(search.getString("location"));
           Start_Job.txtDiscription.setText(search.getString("discription"));
         
                 ResultSet search1 = DB.search("SELECT * FROM work_order WHERE vehicle_id='"+search.getString("vehicle_number")+"'");
                    String orderId=null;
                    while(search1.next()){
                    ...
                    if(search2.next()){
                    Start_Job.txtLastMeter.setEditable(false);
                    Start_Job.txtLastMeter.setText(search2.getString("end_meter"));
                    }else{
                       Start_Job.txtLastMeter.setEditable(true);
                       Start_Job.txtLastMeter.grabFocus();
                    }
            }
        } catch (Exception e) {
            e.printStackTrace();
