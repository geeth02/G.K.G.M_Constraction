 ...
 * @author geeth
 */
public class Add_Customer_Rent_Item extends javax.swing.JFrame {

    /**
     * Creates new form Add_Customer_Befor_Start
     */
    public Add_Customer_Rent_Item() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Add_Customer_Rent_Item.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        try {
            ...
            if(search.next()){
             ...
             if(search.getInt("status")==1){
              new Rent_Item().setVisible(true);
             Rent_Item.txtCustomerId.setText(search.getString("customer_id"));
             Rent_Item.txtItemId.grabFocus();
             this.dispose();
             }else{}
            }else{
            String gender;
             ...
             new Rent_Item().setVisible(true);
             Rent_Item.txtCustomerId.setText(txtReId.getText());
             Rent_Item.txtItemId.grabFocus();
