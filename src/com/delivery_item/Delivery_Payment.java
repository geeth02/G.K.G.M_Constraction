 ...
 * @author geeth
 */
public class Delivery_Payment extends javax.swing.JFrame {

    /**
     * Creates new form End_Job
     */
    public Delivery_Payment() {
        initComponents();
        generatePId();
        txtSearch.grabFocus();
    ...
    private void initComponents() {
        ...
        ReForm.add(jScrollPane7, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 280, 480, 140));
        ...
        ReForm.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 230, 175, 42));
        ...
        ReForm.add(txtCustomer, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 230, 480, 40));

        jLabel15.setFont(new java.awt.Font("Yu Gothic UI Light", 0, 24)); // NOI18N
        jLabel15.setText("Payment History");
        ReForm.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 290, 180, 43));

        jLabel6.setFont(new java.awt.Font("Yu Gothic UI Light", 0, 24)); // NOI18N
        jLabel6.setText("Availble Payments");
        ReForm.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 480, 190, 40));
        ...
        ReForm.add(txtNetAmount, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 480, 480, 43));

        jLabel7.setFont(new java.awt.Font("Yu Gothic UI Light", 0, 24)); // NOI18N
        jLabel7.setText("Total Paid Amount");
        ReForm.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 430, -1, 40));
        ...
        ReForm.add(txtCustomerPayment, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 430, 480, 43));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Delivery_Payment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
